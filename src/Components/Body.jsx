    ...
    return (
        <div className='space-y-4 lg:flex'>
            ...
            <div className='lg: flex-1 lg:order-1'>
                ...
                <p className='font-lato text-gray-400'>With Hosterr, get your website up and running in no less than 5 minutes with the most competitive procing paksages availabel online. </p>
                <form action='' className='flex flex-col gap-4 md:flex-row'>
                    <input type="text" placeholder='Enter your email' className='border-2 border-black p-2 rounded-md px-4 py-3 placeholder:text-gray-400'/>
                    <button className='rounded-md px-4 py-3 bg-blue-400 hover:bg-blue-600 text-white'>Join waitlist</button>
                </form>
                <div className='flex gap-2'>
                    <img src='assets/Checkmark.svg'/>
                    <p className='text-lato text-gray-400'>No Spam, ever. Unsubscribe anytime</p>
                </div>
            </div>
        </div>
    )
